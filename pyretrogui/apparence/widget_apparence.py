...
from pyretrogui.apparence.theme import ThemeState, Theme
from pyretrogui.events.theme_events_dispatcher import ThemeEventsDispatcher


class WidgetApparenceMode(Enum):
    """
...
class WidgetApparence:
    ...
    """
    def __init__(self, mode: WidgetApparenceMode = WidgetApparenceMode.CUSTOM):
        """
    ...
    def background(self) -> tuple[int,int,int]:
        ...
        if self.mode == WidgetApparenceMode.CUSTOM:
    ...
    def set_theme_state(self):
        ...
        """
        match self.mode:
            case WidgetApparenceMode.CUSTOM:
            ...
            case WidgetApparenceMode.PRIMARY:
            ...
            case WidgetApparenceMode.SECONDARY:
                self._theme_state = ThemeState()
            ...
            case WidgetApparenceMode.TERTIARY:
                self._theme_state = ThemeState()
            ...
            case WidgetApparenceMode.SUCCESS:
                self._theme_state = ThemeState()
            ...
            case WidgetApparenceMode.WARNING:
                self._theme_state = ThemeState()
            ...
            case WidgetApparenceMode.ERROR:
                self._theme_state = ThemeState()
