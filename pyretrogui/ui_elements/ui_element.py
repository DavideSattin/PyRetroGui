...
class UIElement(ABC):
      ...
      def init(self,context: Context):
          view_port = LayoutManager().get_view_port(self)
      ...
      # # TODO:  Move this to a class called layout manager.
      # def get_view_port(self) -> ViewPort:
      ...
      #             return self.parent.get_internal_viewport()
      #
      ...
      #
      # def get_internal_viewport(self) -> ViewPort:
