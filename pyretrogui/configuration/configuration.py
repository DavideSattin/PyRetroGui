...
class Configuration:
      ...
      def load (self) -> ApplicationConfig:
          ...
          yaml_data = yaml_manager.load()

          # Root configuration.
          configuration_data = ApplicationConfig
          configuration_data.title = yaml_data.get_data("application", "title", default="")
          configuration_data.size = yaml_data.get_data("application", "size", default=(0,0))

          # Read the font configuration.
          font_size = yaml_data.get_data("application", "font", "font_size", default=(8,16))
          font_path = yaml_data.get_data("application", "font", "font_path", default="")
